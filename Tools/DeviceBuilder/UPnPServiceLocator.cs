...
namespace UPnPStackBuilder
{
	...
	public class UPnPServiceLocator : System.Windows.Forms.Form
	{
		...
		private delegate void UpdateTreeRemoveDelegate(ArrayList list);
		private UPnPService service = null;
        public UPnPService Service { get { return service; } }
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Select a UPnP network service from which the service description will be loaded f" +
				"rom.";
			// 
			// UPnPServiceLocator
			// 
			...
			this.Text = "Service SCPD Locator";
		...
		private void HandleTreeUpdate_Remove(ArrayList list)
		{
