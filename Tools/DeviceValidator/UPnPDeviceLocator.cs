...
{
	/// <summary>
	/// Summary description for UPnPDeviceLocator.
	/// </summary>
	public class UPnPDeviceLocator : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.deviceTree.Location = new System.Drawing.Point(8, 64);
			this.deviceTree.Name = "deviceTree";
			this.deviceTree.Size = new System.Drawing.Size(320, 240);
			...
			this.label1.Text = "Select a network device from which the as a validation target. If the device is c" +
				"onnected on the network but does not show up in the dialog box, the device could" +
				" not be detected or it\'s SCDP document could not be parsed correctly.";
			// 
			// UPnPDeviceLocator
			// 
			...
			this.Text = "Target Device Selection";
		...
		{
            if (deviceTree.SelectedNode == null || deviceTree.SelectedNode.Tag == null) return;
