...
namespace UPnPSniffer
{
    static class Program
    {
        ...
        public static void ExceptionSink(object sender, System.Threading.ThreadExceptionEventArgs args)
        {
            ...
            OpenSource.Utilities.InstanceTracker.GenerateExceptionFile("Exceptions-DeviceSniffer.txt", args.Exception.ToString(), OpenSource.Utilities.InstanceTracker.VersionString);
        }
        ...
        public static void UnhandledExceptionEventSink(object sender, UnhandledExceptionEventArgs args)
        {
            ...
            OpenSource.Utilities.InstanceTracker.GenerateExceptionFile("Exceptions-DeviceSniffer.txt", ((Exception)args.ExceptionObject).ToString(), OpenSource.Utilities.InstanceTracker.VersionString);
        }
    }
}
