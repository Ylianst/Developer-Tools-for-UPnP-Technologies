...
#define ILibAddRequest_Direct(ClientModule, buffer, bufferlength,Destination, CallbackPtr, InterruptPtr, user, user2) ILibAddRequest_DirectEx(ClientModule, buffer, bufferlength,NULL,0,Destination, CallbackPtr, InterruptPtr, user, user2)
