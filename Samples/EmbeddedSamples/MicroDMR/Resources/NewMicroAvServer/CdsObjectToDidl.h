...
enum CdsFilterBits
{
	CdsFilter_Creator		= 0x01,			/* for dc:creator */
	CdsFilter_Res			= 0x02,			/* for minimal <res> element: only protocolInfo and value */
	CdsFilter_Resolution	= 0x04,			/* infers CdsFilter_Res bit is true. Includes resolution attribute of <res> element. */
	CdsFilter_Duration		= 0x08,			/* infers CdsFilter_Res bit is true. Includes duration attribute of <res> element. */
	CdsFilter_Bitrate		= 0x08,			/* infers CdsFilter_Res bit is true. Includes bitrate attribute of <res> element. */
	CdsFilter_ColorDepth	= 0x10,			/* infers CdsFilter_Res bit is true. Includes colorDepth attribute of <res> element. */
	CdsFilter_Size			= 0x20,			/* infers CdsFilter_Res bit is true. Includes size attribute of <res> element. */

	CdsFilter_ChildCount	= 0x40,			/* childCount attribute of container */
	CdsFilter_Searchable	= 0x80,			/* searchable attribute of container */
