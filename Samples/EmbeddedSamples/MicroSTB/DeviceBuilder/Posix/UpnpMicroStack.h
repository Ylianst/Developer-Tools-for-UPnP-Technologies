...
extern void UpnpMediaServer_ConnectionManager_GetCurrentConnectionInfo(void* upnptoken,int ConnectionID);
extern void UpnpMediaServer_ConnectionManager_GetProtocolInfo(void* upnptoken);
extern void UpnpMediaServer_ConnectionManager_GetCurrentConnectionIDs(void* upnptoken);
extern void UpnpMediaServer_ContentDirectory_Browse(void* upnptoken,char* ObjectID,char* BrowseFlag,char* Filter,unsigned int StartingIndex,unsigned int RequestedCount,char* SortCriteria);
extern void UpnpMediaServer_ContentDirectory_GetSortCapabilities(void* upnptoken);
extern void UpnpMediaServer_ContentDirectory_GetSystemUpdateID(void* upnptoken);
extern void UpnpMediaServer_ContentDirectory_GetSearchCapabilities(void* upnptoken);
...
void UpnpResponse_MediaServer_ContentDirectory_Browse(const void* UPnPToken, const char* Result, const unsigned int NumberReturned, const unsigned int TotalMatches, const unsigned int UpdateID);
void UpnpResponse_MediaServer_ContentDirectory_GetSortCapabilities(const void* UPnPToken, const char* SortCaps);
void UpnpResponse_MediaServer_ContentDirectory_GetSystemUpdateID(const void* UPnPToken, const unsigned int Id);
void UpnpResponse_MediaServer_ContentDirectory_GetSearchCapabilities(const void* UPnPToken, const char* SearchCaps);
void UpnpResponse_MediaServer_ConnectionManager_GetCurrentConnectionInfo(const void* UPnPToken, const int RcsID, const int AVTransportID, const char* ProtocolInfo, const char* PeerConnectionManager, const int PeerConnectionID, const char* Direction, const char* Status);
void UpnpResponse_MediaServer_ConnectionManager_GetProtocolInfo(const void* UPnPToken, const char* Source, const char* Sink);
void UpnpResponse_MediaServer_ConnectionManager_GetCurrentConnectionIDs(const void* UPnPToken, const char* ConnectionIDs);
...
void UpnpSetState_MediaServer_ContentDirectory_SystemUpdateID(void *microstack,unsigned int val);
void UpnpSetState_MediaServer_ConnectionManager_SourceProtocolInfo(void *microstack,char* val);
void UpnpSetState_MediaServer_ConnectionManager_SinkProtocolInfo(void *microstack,char* val);
void UpnpSetState_MediaServer_ConnectionManager_CurrentConnectionIDs(void *microstack,char* val);
