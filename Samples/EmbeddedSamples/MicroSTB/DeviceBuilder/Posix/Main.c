...
{
	printf("Invoke: UpnpMediaServer_ContentDirectory_Browse(%s,%s,%s,%u,%u,%s);\r\n",ObjectID,BrowseFlag,Filter,StartingIndex,RequestedCount,SortCriteria);
	
	/* TODO: Place Action Code Here... */
	
	/* UpnpResponse_Error(upnptoken,404,"Method Not Implemented"); */
	/* UpnpResponse_MediaServer_ContentDirectory_Browse(upnptoken,"Sample String",250,250,250); */
...
{
	printf("Invoke: UpnpMediaServer_ContentDirectory_GetSortCapabilities();\r\n");
	
	/* TODO: Place Action Code Here... */
	
	/* UpnpResponse_Error(upnptoken,404,"Method Not Implemented"); */
	UpnpResponse_MediaServer_ContentDirectory_GetSortCapabilities(upnptoken,"Sample String");
}

void UpnpMediaServer_ContentDirectory_GetSystemUpdateID(void* upnptoken)
{
	printf("Invoke: UpnpMediaServer_ContentDirectory_GetSystemUpdateID();\r\n");
	
	/* TODO: Place Action Code Here... */
	
	/* UpnpResponse_Error(upnptoken,404,"Method Not Implemented"); */
	UpnpResponse_MediaServer_ContentDirectory_GetSystemUpdateID(upnptoken,250);
}

void UpnpMediaServer_ContentDirectory_GetSearchCapabilities(void* upnptoken)
{
	printf("Invoke: UpnpMediaServer_ContentDirectory_GetSearchCapabilities();\r\n");
	
	/* TODO: Place Action Code Here... */
	
	/* UpnpResponse_Error(upnptoken,404,"Method Not Implemented"); */
	UpnpResponse_MediaServer_ContentDirectory_GetSearchCapabilities(upnptoken,"Sample String");
}

void UpnpMediaServer_ConnectionManager_GetCurrentConnectionInfo(void* upnptoken,int ConnectionID)
{
	printf("Invoke: UpnpMediaServer_ConnectionManager_GetCurrentConnectionInfo(%d);\r\n",ConnectionID);
	
	/* TODO: Place Action Code Here... */
	
	/* UpnpResponse_Error(upnptoken,404,"Method Not Implemented"); */
	UpnpResponse_MediaServer_ConnectionManager_GetCurrentConnectionInfo(upnptoken,25000,25000,"Sample String","Sample String",25000,"Sample String","Sample String");
}

void UpnpMediaServer_ConnectionManager_GetProtocolInfo(void* upnptoken)
{
	printf("Invoke: UpnpMediaServer_ConnectionManager_GetProtocolInfo();\r\n");
	
	/* TODO: Place Action Code Here... */
	
	/* UpnpResponse_Error(upnptoken,404,"Method Not Implemented"); */
	UpnpResponse_MediaServer_ConnectionManager_GetProtocolInfo(upnptoken,"Sample String","Sample String");
}

void UpnpMediaServer_ConnectionManager_GetCurrentConnectionIDs(void* upnptoken)
{
	printf("Invoke: UpnpMediaServer_ConnectionManager_GetCurrentConnectionIDs();\r\n");
	
	/* TODO: Place Action Code Here... */
	
	/* UpnpResponse_Error(upnptoken,404,"Method Not Implemented"); */
	UpnpResponse_MediaServer_ConnectionManager_GetCurrentConnectionIDs(upnptoken,"Sample String");
}
...
int main(void)
{
	...
	UpnpmicroStack = UpnpCreateMicroStack(UpnpmicroStackChain,"MicroSTB","4634854f-ccb8-4140-b694-a67301f0cae7","0000001",1800,0);
	...
	UpnpSetState_MediaServer_ContentDirectory_SystemUpdateID(UpnpmicroStack,250);
	UpnpSetState_MediaServer_ConnectionManager_SourceProtocolInfo(UpnpmicroStack,"Sample String");
	UpnpSetState_MediaServer_ConnectionManager_SinkProtocolInfo(UpnpmicroStack,"Sample String");
	UpnpSetState_MediaServer_ConnectionManager_CurrentConnectionIDs(UpnpmicroStack,"Sample String");
	
	printf("Intel MicroStack 1.0 - MicroSTB\r\n\r\n");
