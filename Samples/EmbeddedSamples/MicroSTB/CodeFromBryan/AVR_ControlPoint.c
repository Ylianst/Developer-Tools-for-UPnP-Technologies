...
void AVR_Renew(void *state);
void AVR_SSDP_Sink(void *sender, char* UDN, int Alive, char* LocationURL, int Timeout,void *cp);
...
void (*AVR_EventCallback_RenderingControl_LastChange)(struct UPnPService* Service,char* value);
void (*AVR_EventCallback_ConnectionManager_SourceProtocolInfo)(struct UPnPService* Service,char* value);
void (*AVR_EventCallback_ConnectionManager_SinkProtocolInfo)(struct UPnPService* Service,char* value);
void (*AVR_EventCallback_ConnectionManager_CurrentConnectionIDs)(struct UPnPService* Service,char* value);
void (*AVR_EventCallback_AVTransport_LastChange)(struct UPnPService* Service,char* value);
...
void AVR_DestructUPnPService(struct UPnPService *service)
{
	...
	{
		ILibLifeTime_Remove(((struct AVR_CP*)service->Parent->CP)->LifeTimeMonitor,service);
		ILibDeleteEntry(((struct AVR_CP*)service->Parent->CP)->SIDTable,service->SubscriptionID,(int)strlen(service->SubscriptionID));
...
void AVR_DestructUPnPDevice(struct UPnPDevice *device)
{
...
{
	struct AVR_CP *CP = (struct AVR_CP*)device->CP;
...
void AVR_Release(struct UPnPDevice *device)
{
	...
	{
		AVR_DestructUPnPDevice(d);
	}
	sem_post(&(CP->DeviceLock));
}
void AVR_DeviceDescriptionInterruptSink(void *sender, void *user1, void *user2)
{
	struct CustomUserData *cd = (struct CustomUserData*)user1;
	FREE(cd->buffer);
	FREE(user1);
}
void AVR_Push(struct UPnP_Stack **pp_Top, void *data)
{
...
void *AVR_Pop(struct UPnP_Stack **pp_Top)
{
...
void *AVR_Peek(struct UPnP_Stack **pp_Top)
{
	struct UPnP_Stack *frame = *pp_Top;
	void *RetVal = NULL;
...
void AVR_Flush(struct UPnP_Stack **pp_Top)
{
	while(AVR_Pop(pp_Top)!=NULL) {}
	*pp_Top = NULL;
}

void AVR_AttachRootUDNToUDN(void *v_CP,char* UDN, char* RootUDN)
{
	struct UDNMapNode *node;
	struct AVR_CP* CP = (struct AVR_CP*)v_CP;
...
void AVR_AttachDeviceToUDN(void *v_CP,char* UDN, struct UPnPDevice *device)
{
	struct UDNMapNode *node;
	struct AVR_CP* CP = (struct AVR_CP*)v_CP;
	if(CP->UDN_Head==NULL) {return;}
...
void AVR_RemoveUDN(void *v_CP,char* UDN)
{
	struct AVR_CP* CP = (struct AVR_CP*)v_CP;
	...
	if(device!=NULL) {AVR_Release(device);}
}
void AVR_MarkUDN(void *v_CP,char *UDN)
{
	struct AVR_CP* CP = (struct AVR_CP*)v_CP;
	struct UDNMapNode *node;
	int has = 0;
...
void AVR_AddUDN(void *v_CP,char *UDN)
{
	struct AVR_CP* CP = (struct AVR_CP*)v_CP;
	struct UDNMapNode *node;
	int has = 0;
...
char* AVR_GetRootUDNAtUDN(void *v_CP,char* UDN)
{
	struct UDNMapNode *node;
	char *RetVal = NULL;
	struct AVR_CP* CP = (struct AVR_CP*)v_CP;
...
int AVR_HasUDN(void *v_CP,char *UDN)
{
	struct UDNMapNode *node;
	struct AVR_CP* CP = (struct AVR_CP*)v_CP;
	int RetVal = 0;
...
struct packetheader *AVR_BuildPacket(char* IP, int Port, char* Path, char* cmd)
{
	...
	ILibAddHeaderLine(RetVal,"User-Agent",10,"WINDOWS, UPnP/1.0, Intel MicroStack/1.0.1284",44);
	FREE(HostLine);
	return(RetVal);
}

void AVR_RemoveServiceFromDevice(struct UPnPDevice *device, struct UPnPService *service)
{
	...
	if(s==service)
	{
		...
		AVR_DestructUPnPService(service);
		return;
	}
	while(s->Next!=NULL)
	{
...
void AVR_ProcessDevice(struct UPnPDevice *device)
{
	int OK = 0;
	...
	{
		AVR_ProcessDevice(EmbeddedDevice);
	...
	if(strncmp(device->DeviceType,"urn:schemas-upnp-org:device:MediaRenderer:1",43)==0)
	{
		...
		while(s!=NULL)
		{
			...
			s2 = s->Next;
			if(OK==0) {AVR_RemoveServiceFromDevice(device,s);}
			s = s2;
		}
	}
...
void AVR_PrintUPnPDevice(int indents, struct UPnPDevice *device)
{
	...
	while(d!=NULL)
	{
		AVR_PrintUPnPDevice(indents+5,d);
		d = d->Next;
	}
}
...
{
	return(AVR_GetService(device,"urn:schemas-upnp-org:service:RenderingControl:1",47));
}
struct UPnPService *AVR_GetService_ConnectionManager(struct UPnPDevice *device)
{
	return(AVR_GetService(device,"urn:schemas-upnp-org:service:ConnectionManager:1",48));
}
struct UPnPService *AVR_GetService_AVTransport(struct UPnPDevice *device)
{
	return(AVR_GetService(device,"urn:schemas-upnp-org:service:AVTransport:1",42));
}
struct UPnPDevice *AVR_GetDevice2(struct UPnPDevice *device, int index, int *c_Index)
{
	struct UPnPDevice *RetVal = NULL;
	...
	while(e_Device!=NULL)
	{
		RetVal = AVR_GetDevice2(e_Device,index,&currentIndex);
		if(RetVal!=NULL)
		{
			break;
		}
...
{
	int c_Index = -1;
	return(AVR_GetDevice2(device,index,&c_Index));
}
int AVR_GetDeviceCount(struct UPnPDevice *device)
{
	...
	while(e_Device!=NULL)
	{
		RetVal += AVR_GetDeviceCount(e_Device);
		e_Device = e_Device->Next;
	}
...
int AVR_GetErrorCode(char *buffer, int length)
{
	int RetVal = 500;
...
void AVR_ProcessSCPD(char* buffer, int length, struct UPnPService *service)
{
...
void AVR_DeviceExpired(struct UPnPDevice *device)
{
	LVL3DEBUG(printf("Device[%s] failed to re-advertise in a timely manner\r\n",device->FriendlyName);)
	while(device->Parent!=NULL) {device = device->Parent;}
	AVR_SSDP_Sink(NULL, device->UDN, 0, NULL, 0,device->CP);
}
void AVR_FinishProcessingDevice(struct AVR_CP* CP, struct UPnPDevice *RootDevice)
{
	...
	AVR_AttachDeviceToUDN(CP,RootDevice->UDN,RootDevice);
	AVR_MarkUDN(CP,RootDevice->UDN);
	do
	{
		RetDevice = AVR_GetDevice1(RootDevice,i++);
		if(RetDevice!=NULL)
		{
			AVR_AddUDN(CP,RetDevice->UDN);
			AVR_AttachRootUDNToUDN(CP,RetDevice->UDN,RootUDN);
			AVR_AttachDeviceToUDN(CP,RetDevice->UDN,RetDevice);
	...
	RetDevice = AVR_GetDeviceAtUDN(CP,RootUDN);
	if(RetDevice!=NULL)
	{
		ILibLifeTime_Add(CP->LifeTimeMonitor,RetDevice,Timeout,&AVR_DeviceExpired,NULL);
		AVR_Release(RetDevice);
	}
}
void AVR_SCPD_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* dv, void* sv)
{
	struct UPnPDevice *device;
	struct UPnPService *service = (struct UPnPService*)sv;
	struct AVR_CP *CP = service->Parent->CP;
	
	if(!(header==NULL || header->StatusCode!=200) && done!=0)
	{
		AVR_ProcessSCPD(buffer,EndPointer, service);
		...
		if(device->SCPDLeft==0)
		{
			...
			{
				AVR_FinishProcessingDevice(CP,device);
			}
			else
			{
				AVR_DestructUPnPDevice(device);
			}
		}
	}
	else
...
void AVR_CalculateSCPD_FetchCount(struct UPnPDevice *device)
{
	int count = 0;
	...
	while(e_Device!=NULL)
	{
		AVR_CalculateSCPD_FetchCount(e_Device);
		e_Device = e_Device->Next;
	}
...
void AVR_SCPD_Fetch(struct UPnPDevice *device)
{
	struct UPnPDevice *e_Device = device->EmbeddedDevices;
	struct UPnPService *s;
	char *IP,*Path;
	...
	while(s!=NULL)
	{
		...
		p = AVR_BuildPacket(IP,Port,Path,"GET");
		...
		ILibAddRequest(((struct AVR_CP*)device->CP)->HTTP, p,&addr, &AVR_SCPD_Sink, device, s);
...
struct UPnPDevice* AVR_ProcessDeviceXML_device(struct ILibXMLNode *xml, void *v_CP,const char *BaseURL, int Timeout, int RecvAddr)
{
		...
		if(xml->NameLength==10 && memcmp(xml->Name,"deviceList",10)==0)
		{
			if(xml->Next->StartTag!=0)
			{
				...
				while(flg2==0)
				{
					...
					{
						tempDevice = AVR_ProcessDeviceXML_device(xml,v_CP,BaseURL,Timeout, RecvAddr);
...
void AVR_ProcessDeviceXML(void *v_CP,char* buffer, int BufferSize, char* LocationURL, int RecvAddr, int Timeout)
{
	...
	RootDevice = AVR_ProcessDeviceXML_device(xml,v_CP,BaseURL,Timeout,RecvAddr);
	FREE(BaseURL);
	ILibDestructXMLNodeList(rootXML);
	
	/* Add Root Device to UDNTable */
	AVR_AddUDN(v_CP,RootDevice->UDN);
	...
	AVR_ProcessDevice(RootDevice);
	RootDevice->SCPDLeft = 0;
	AVR_CalculateSCPD_FetchCount(RootDevice);
	if(RootDevice->SCPDLeft==0)
	{
		AVR_FinishProcessingDevice(v_CP,RootDevice);
	}
	else
	{
		AVR_SCPD_Fetch(RootDevice);
	}
}

void AVR_HTTP_Sink_DeviceDescription(
void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* user, void* cp)
{
	...
	{
		AVR_ProcessDeviceXML(cp,buffer,EndPointer-(*p_BeginPointer),customData->buffer,header->ReceivingAddress,customData->Timeout);
	}
	if(done!=0)
	{
...
void AVR__FlushRequest(struct UPnPDevice *device)
{
	...
	while(ed!=NULL)
	{
		AVR__FlushRequest(ed);
		ed = ed->Next;
	}
	while(s!=NULL)
	{
		ILibParseUri(s->ControlURL,&IP,&Port,&Path);
		ILibDeleteRequests(((struct AVR_CP*)device->CP)->HTTP, s);
		FREE(IP);
		FREE(Path);
		s = s->Next;
	}
...
void AVR_SSDP_Sink(void *sender, char* UDN, int Alive, char* LocationURL, int Timeout,void *cp)
{
	...
	if(Alive!=0)
	{
		...
		if(AVR_HasUDN(cp,LocationURL)==0)
		{
			AVR_AddUDN(cp,LocationURL);
			if(AVR_HasUDN(cp,UDN)==0)
			{
				AVR_AddUDN(cp,UDN);
				ILibParseUri(LocationURL,&IP,&Port,&Path);
				...
				ILibAddRequest(((struct AVR_CP*)cp)->HTTP, p,&addr, &AVR_HTTP_Sink_DeviceDescription,customData, cp);
		...
		else
		{
			...
			if(AVR_HasUDN(cp,UDN)!=0)
			{
				buffer = AVR_GetRootUDNAtUDN(cp,UDN);
				if(buffer!=NULL)
				{
					device = AVR_GetDeviceAtUDN(cp,buffer);
					if(device!=NULL)
					{
						//Extend LifetimeMonitor duration
						ILibLifeTime_Remove(((struct AVR_CP*)cp)->LifeTimeMonitor,device);
						ILibLifeTime_Add(((struct AVR_CP*)cp)->LifeTimeMonitor,device,Timeout,&AVR_DeviceExpired,NULL);
						AVR_Release(device);
					}
				}
			}
	...
	else
	{
		...
		device = AVR_GetDeviceAtUDN(cp,UDN);
		if(device!=NULL)
		{
			ILibLifeTime_Remove(((struct AVR_CP*)cp)->LifeTimeMonitor,device);
			AVR_RemoveUDN(cp,device->LocationURL);
			do
			{
				tempDevice = AVR_GetDevice1(device,i++);
				if(tempDevice!=NULL)
				{
					AVR__FlushRequest(tempDevice);
					if(((struct AVR_CP*)cp)->RemoveSink!=NULL)
					{
						((struct AVR_CP*)cp)->RemoveSink(tempDevice);
					}
				}
			...
			AVR_Release(device);
			AVR_RemoveUDN(cp,UDN);
		}
	}
}
void AVR_RenderingControl_EventSink(char* buffer, int bufferlength, struct UPnPService *service)
{
	struct ILibXMLNode *xml,*rootXML;
	char *tempString;
	int tempStringLength;
					...
					if(xml->NameLength==8 && memcmp(xml->Name,"property",8)==0)
					{
						...
						while(flg2==0)
						{
							if(xml->NameLength==10 && memcmp(xml->Name,"LastChange",10) == 0)
							{
								...
								if(AVR_EventCallback_RenderingControl_LastChange != NULL)
								{
									AVR_EventCallback_RenderingControl_LastChange(service,LastChange);
								}
							}
							if(xml->Peer!=NULL)
							{
...
void AVR_ConnectionManager_EventSink(char* buffer, int bufferlength, struct UPnPService *service)
{
	struct ILibXMLNode *xml,*rootXML;
	char *tempString;
	int tempStringLength;
					...
					if(xml->NameLength==8 && memcmp(xml->Name,"property",8)==0)
					{
						...
						while(flg2==0)
						{
							if(xml->NameLength==18 && memcmp(xml->Name,"SourceProtocolInfo",18) == 0)
							{
								...
								if(AVR_EventCallback_ConnectionManager_SourceProtocolInfo != NULL)
								{
									AVR_EventCallback_ConnectionManager_SourceProtocolInfo(service,SourceProtocolInfo);
								}
							}
							if(xml->NameLength==16 && memcmp(xml->Name,"SinkProtocolInfo",16) == 0)
							{
								...
								if(AVR_EventCallback_ConnectionManager_SinkProtocolInfo != NULL)
								{
									AVR_EventCallback_ConnectionManager_SinkProtocolInfo(service,SinkProtocolInfo);
								}
							}
							if(xml->NameLength==20 && memcmp(xml->Name,"CurrentConnectionIDs",20) == 0)
							{
								...
								if(AVR_EventCallback_ConnectionManager_CurrentConnectionIDs != NULL)
								{
									AVR_EventCallback_ConnectionManager_CurrentConnectionIDs(service,CurrentConnectionIDs);
								}
							}
							if(xml->Peer!=NULL)
							{
...
void AVR_AVTransport_EventSink(char* buffer, int bufferlength, struct UPnPService *service)
{
	struct ILibXMLNode *xml,*rootXML;
	char *tempString;
	int tempStringLength;
					...
					if(xml->NameLength==8 && memcmp(xml->Name,"property",8)==0)
					{
						...
						while(flg2==0)
						{
							if(xml->NameLength==10 && memcmp(xml->Name,"LastChange",10) == 0)
							{
								...
								tempString[tempStringLength] = '\0';
								LastChange = tempString;
								if(AVR_EventCallback_AVTransport_LastChange != NULL)
								{
									AVR_EventCallback_AVTransport_LastChange(service,LastChange);
								}
							}
							if(xml->Peer!=NULL)
							{
...
void AVR_OnEventSink(void *ReaderObject, struct packetheader *header, char* buffer, int *BeginPointer, int BufferSize, int done, void* user)
{
	int type_length;
	char* sid = NULL;
	void* value = NULL;
	...
	if(done!=0)
	{
		...
		ILibAddHeaderLine(resp,"Server",6,"WINDOWS, UPnP/1.0, Intel MicroStack/1.0.1284",44);
		...
		while(field!=NULL)
		{
			if(field->FieldLength==3)
			{
				if(strncasecmp(field->Field,"SID",3)==0)
				{
					...
					value = ILibGetEntry(((struct AVR_CP*)user)->SIDTable,field->FieldData,field->FieldDataLength);
					break;
				}
			}
...
void AVR_OnSubscribeSink(void *ReaderObject, struct packetheader *header, int IsInterrupt,char* buffer, int *BeginPointer, int BufferSize, int done, void* user, void *vcp)
{
	struct UPnPService *s;
	struct UPnPDevice *d;
	struct packetheader_field_node *field;
	struct parser_result *p;
	struct AVR_CP *cp = (struct AVR_CP*)vcp;
			...
			if(header->StatusCode==200)
			{
				...
				while(field!=NULL)
				{
					...
					if(field->FieldLength==7 && strncasecmp(field->Field,"TIMEOUT",7)==0)
					{
						...
						ILibLifeTime_Add(cp->LifeTimeMonitor,s,atoi(p->LastResult->data)/2,&AVR_Renew,NULL);
...
void AVR_Renew(void *state)
{
	...
	ILibAddHeaderLine(p,"User-Agent",10,"WINDOWS, UPnP/1.0, Intel MicroStack/1.0.1284",44);
	...
	ILibAddRequest(((struct AVR_CP*)service->Parent->CP)->HTTP, p,&destaddr, &AVR_OnSubscribeSink,(void*)service, service->Parent->CP);
	...
	while(mn!=NULL)
	{
		...
		if(mn->device!=NULL && mn->MARKED!=0)
		{
			...
			if(CP->RemoveSink!=NULL)
			{
				do
				{
					RetDevice = AVR_GetDevice1(mn->device,i++);
					if(RetDevice!=NULL)
					{
			...
			AVR_DestructUPnPDevice(mn->device);
		}
...
{
	((struct AVR_CP*)CPToken)->RecheckFlag = 1;
	ILibForceUnBlockChain(((struct AVR_CP*)CPToken)->Chain);
}
void AVR_CP_ProcessDeviceRemoval(struct AVR_CP* CP, struct UPnPDevice *device)
{
	...
	while(temp!=NULL)
	{
		AVR_CP_ProcessDeviceRemoval(CP,temp);
		temp = temp->Next;
	}
...
void AVR_CP_PreSelect(void *CPToken,fd_set *readset, fd_set *writeset, fd_set *errorset, int *blocktime)
{
	struct UDNMapNode *mn,*mn2;
	struct AVR_CP *CP= (struct AVR_CP*)CPToken;
	int *IPAddressList;
	int NumAddressList;
	int i;
	int found;
		...
		while(mn!=NULL)
		{
			...
			if(mn->device!=NULL)
			{
				...
				if(found==0)
				{
					...
					AVR_CP_ProcessDeviceRemoval(CP,mn->device);
...
{
	struct AVR_CP *cp = (struct AVR_CP*)MALLOC(sizeof(struct AVR_CP));
	
	cp->Destroy = &AVR_StopCP;
	cp->PostSelect = NULL;
	cp->PreSelect = &AVR_CP_PreSelect;
	cp->DiscoverSink = A;
	cp->RemoveSink = R;
	
	sem_init(&(cp->DeviceLock),0,1);
	cp->UDN_Head = NULL;
	cp->WebServer = ILibCreateMiniWebServer(Chain,5,&AVR_OnEventSink,cp);
	cp->SIDTable = ILibInitHashTree();
	
	cp->SSDP = ILibCreateSSDPClientModule(Chain,"urn:schemas-upnp-org:device:MediaRenderer:1", 43, &AVR_SSDP_Sink,cp);
...
void AVR_Invoke_RenderingControl_SetVolume_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*))_InvokeData->CallbackPtr)(Service,AVR_GetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User);
			AVR_Release(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void AVR_Invoke_RenderingControl_SetVolume(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* Channel, unsigned short DesiredVolume)
{
	int headerLength;
	char *headerBuffer;
	...
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_RenderingControl_SetVolume_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_RenderingControl_GetMute_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 1;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,int))_InvokeData->CallbackPtr)(Service,AVR_GetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA);
			AVR_Release(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void AVR_Invoke_RenderingControl_GetMute(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,int), void* user, unsigned int InstanceID, char* Channel)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_RenderingControl_GetMute_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_RenderingControl_SetMute_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void AVR_Invoke_RenderingControl_SetMute(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* Channel, int DesiredMute)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_RenderingControl_SetMute_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_RenderingControl_GetVolume_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 1;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,unsigned short))_InvokeData->CallbackPtr)(Service,AVR_GetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA);
			AVR_Release(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void AVR_Invoke_RenderingControl_GetVolume(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,unsigned short), void* user, unsigned int InstanceID, char* Channel)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_RenderingControl_GetVolume_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_ConnectionManager_GetCurrentConnectionInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 7;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,int,int,char*,char*,int,char*,char*))_InvokeData->CallbackPtr)(Service,AVR_GetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA);
			AVR_Release(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void AVR_Invoke_ConnectionManager_GetCurrentConnectionInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,int,int,char*,char*,int,char*,char*), void* user, int ConnectionID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_ConnectionManager_GetCurrentConnectionInfo_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_ConnectionManager_GetProtocolInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 2;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,char*,char*))_InvokeData->CallbackPtr)(Service,AVR_GetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA);
			AVR_Release(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void AVR_Invoke_ConnectionManager_GetProtocolInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*,char*), void* user)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_ConnectionManager_GetProtocolInfo_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_ConnectionManager_GetCurrentConnectionIDs_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 1;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,char*))_InvokeData->CallbackPtr)(Service,AVR_GetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA);
			AVR_Release(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void AVR_Invoke_ConnectionManager_GetCurrentConnectionIDs(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*), void* user)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_ConnectionManager_GetCurrentConnectionIDs_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_GetCurrentTransportActions_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 1;
...
void AVR_Invoke_AVTransport_GetCurrentTransportActions(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_GetCurrentTransportActions_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_Play_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void AVR_Invoke_AVTransport_Play(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* Speed)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_Play_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_Previous_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void AVR_Invoke_AVTransport_Previous(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_Previous_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_Next_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void AVR_Invoke_AVTransport_Next(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_Next_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_Stop_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void AVR_Invoke_AVTransport_Stop(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_Stop_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_GetTransportSettings_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 2;
...
void AVR_Invoke_AVTransport_GetTransportSettings(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_GetTransportSettings_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_Seek_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void AVR_Invoke_AVTransport_Seek(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* Unit, char* Target)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_Seek_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_Pause_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void AVR_Invoke_AVTransport_Pause(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_Pause_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_GetPositionInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 8;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,unsigned int,char*,char*,char*,char*,char*,int,int))_InvokeData->CallbackPtr)(Service,AVR_GetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA);
			AVR_Release(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void AVR_Invoke_AVTransport_GetPositionInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,unsigned int,char*,char*,char*,char*,char*,int,int), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_GetPositionInfo_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_GetTransportInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 3;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,char*,char*,char*))_InvokeData->CallbackPtr)(Service,AVR_GetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA,INVALID_DATA);
			AVR_Release(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void AVR_Invoke_AVTransport_GetTransportInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*,char*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_GetTransportInfo_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_SetAVTransportURI_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void AVR_Invoke_AVTransport_SetAVTransportURI(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* CurrentURI, char* CurrentURIMetaData)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_SetAVTransportURI_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_GetDeviceCapabilities_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 3;
...
void AVR_Invoke_AVTransport_GetDeviceCapabilities(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*,char*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_GetDeviceCapabilities_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_SetPlayMode_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void AVR_Invoke_AVTransport_SetPlayMode(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* NewPlayMode)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_SetPlayMode_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void AVR_Invoke_AVTransport_GetMediaInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 9;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,unsigned int,char*,char*,char*,char*,char*,char*,char*,char*))_InvokeData->CallbackPtr)(Service,AVR_GetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA);
			AVR_Release(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void AVR_Invoke_AVTransport_GetMediaInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,unsigned int,char*,char*,char*,char*,char*,char*,char*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct AVR_CP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &AVR_Invoke_AVTransport_GetMediaInfo_Sink,service, invoke_data);	
...
void AVR_SubscribeForUPnPEvents(struct UPnPService *service, void(*callbackPtr)(struct UPnPService* service,int OK))
{
	...
	sprintf(callback,"<http://%s:%d%s>",service->Parent->InterfaceToHost,ILibGetMiniWebServerPortNumber(((struct AVR_CP*)service->Parent->CP)->WebServer),Path);
