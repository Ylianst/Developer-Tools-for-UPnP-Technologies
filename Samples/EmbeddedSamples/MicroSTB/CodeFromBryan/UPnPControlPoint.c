...
void (*UPnPEventCallback_RenderingControl_LastChange)(struct UPnPService* Service,char* value);
void (*UPnPEventCallback_ConnectionManager_SourceProtocolInfo)(struct UPnPService* Service,char* value);
void (*UPnPEventCallback_ConnectionManager_SinkProtocolInfo)(struct UPnPService* Service,char* value);
void (*UPnPEventCallback_ConnectionManager_CurrentConnectionIDs)(struct UPnPService* Service,char* value);
void (*UPnPEventCallback_AVTransport_LastChange)(struct UPnPService* Service,char* value);
...
void UPnPMarkUDN(void *v_CP,char *UDN)
{
	struct UPnPCP* CP = (struct UPnPCP*)v_CP;
	struct UDNMapNode *node;
	int has = 0;
...
struct UPnPService *UPnPGetService_RenderingControl(struct UPnPDevice *device)
{
	return(UPnPGetService(device,"urn:schemas-upnp-org:service:RenderingControl:1",47));
}
struct UPnPService *UPnPGetService_ConnectionManager(struct UPnPDevice *device)
{
	return(UPnPGetService(device,"urn:schemas-upnp-org:service:ConnectionManager:1",48));
}
struct UPnPService *UPnPGetService_AVTransport(struct UPnPDevice *device)
{
	return(UPnPGetService(device,"urn:schemas-upnp-org:service:AVTransport:1",42));
}
...
void UPnPRenderingControl_EventSink(char* buffer, int bufferlength, struct UPnPService *service)
{
	struct ILibXMLNode *xml,*rootXML;
	char *tempString;
	int tempStringLength;
					...
					if(xml->NameLength==8 && memcmp(xml->Name,"property",8)==0)
					{
						...
						while(flg2==0)
						{
							if(xml->NameLength==10 && memcmp(xml->Name,"LastChange",10) == 0)
							{
								...
								if(UPnPEventCallback_RenderingControl_LastChange != NULL)
								{
									UPnPEventCallback_RenderingControl_LastChange(service,LastChange);
								}
							}
							if(xml->Peer!=NULL)
							{
...
void UPnPConnectionManager_EventSink(char* buffer, int bufferlength, struct UPnPService *service)
{
	struct ILibXMLNode *xml,*rootXML;
	char *tempString;
	int tempStringLength;
					...
					if(xml->NameLength==8 && memcmp(xml->Name,"property",8)==0)
					{
						...
						while(flg2==0)
						{
							if(xml->NameLength==18 && memcmp(xml->Name,"SourceProtocolInfo",18) == 0)
							{
								...
								if(UPnPEventCallback_ConnectionManager_SourceProtocolInfo != NULL)
								{
									UPnPEventCallback_ConnectionManager_SourceProtocolInfo(service,SourceProtocolInfo);
								}
							}
							if(xml->NameLength==16 && memcmp(xml->Name,"SinkProtocolInfo",16) == 0)
							{
								...
								if(UPnPEventCallback_ConnectionManager_SinkProtocolInfo != NULL)
								{
									UPnPEventCallback_ConnectionManager_SinkProtocolInfo(service,SinkProtocolInfo);
								}
							}
							if(xml->NameLength==20 && memcmp(xml->Name,"CurrentConnectionIDs",20) == 0)
							{
								...
								if(UPnPEventCallback_ConnectionManager_CurrentConnectionIDs != NULL)
								{
									UPnPEventCallback_ConnectionManager_CurrentConnectionIDs(service,CurrentConnectionIDs);
								}
							}
							if(xml->Peer!=NULL)
							{
...
void UPnPAVTransport_EventSink(char* buffer, int bufferlength, struct UPnPService *service)
{
	struct ILibXMLNode *xml,*rootXML;
	char *tempString;
	int tempStringLength;
					...
					if(xml->NameLength==8 && memcmp(xml->Name,"property",8)==0)
					{
						...
						while(flg2==0)
						{
							if(xml->NameLength==10 && memcmp(xml->Name,"LastChange",10) == 0)
							{
								...
								tempString[tempStringLength] = '\0';
								LastChange = tempString;
								if(UPnPEventCallback_AVTransport_LastChange != NULL)
								{
									UPnPEventCallback_AVTransport_LastChange(service,LastChange);
								}
							}
							if(xml->Peer!=NULL)
							{
...
void *UPnPCreateControlPoint(void *Chain, void(*A)(struct UPnPDevice*),void(*R)(struct UPnPDevice*))
{
	...
	cp->SSDP = ILibCreateSSDPClientModule(Chain,"urn:schemas-upnp-org:device:MediaRenderer:1", 43, &UPnPSSDP_Sink,cp);
...
void UPnPInvoke_RenderingControl_SetVolume_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
...
void UPnPInvoke_RenderingControl_SetVolume(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* Channel, unsigned short DesiredVolume)
{
	int headerLength;
	char *headerBuffer;
	...
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_RenderingControl_SetVolume_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_RenderingControl_GetMute_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 1;
...
void UPnPInvoke_RenderingControl_GetMute(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,int), void* user, unsigned int InstanceID, char* Channel)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_RenderingControl_GetMute_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_RenderingControl_SetMute_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void UPnPInvoke_RenderingControl_SetMute(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* Channel, int DesiredMute)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_RenderingControl_SetMute_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_RenderingControl_GetVolume_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 1;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,unsigned short))_InvokeData->CallbackPtr)(Service,UPnPGetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA);
			UPnPRelease(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void UPnPInvoke_RenderingControl_GetVolume(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,unsigned short), void* user, unsigned int InstanceID, char* Channel)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_RenderingControl_GetVolume_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_ConnectionManager_GetCurrentConnectionInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 7;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,int,int,char*,char*,int,char*,char*))_InvokeData->CallbackPtr)(Service,UPnPGetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA);
			UPnPRelease(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void UPnPInvoke_ConnectionManager_GetCurrentConnectionInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,int,int,char*,char*,int,char*,char*), void* user, int ConnectionID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_ConnectionManager_GetCurrentConnectionInfo_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_ConnectionManager_GetProtocolInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 2;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,char*,char*))_InvokeData->CallbackPtr)(Service,UPnPGetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA);
			UPnPRelease(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void UPnPInvoke_ConnectionManager_GetProtocolInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*,char*), void* user)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_ConnectionManager_GetProtocolInfo_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_ConnectionManager_GetCurrentConnectionIDs_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 1;
...
void UPnPInvoke_ConnectionManager_GetCurrentConnectionIDs(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*), void* user)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_ConnectionManager_GetCurrentConnectionIDs_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_GetCurrentTransportActions_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 1;
...
void UPnPInvoke_AVTransport_GetCurrentTransportActions(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_GetCurrentTransportActions_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_Play_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void UPnPInvoke_AVTransport_Play(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* Speed)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_Play_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_Previous_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void UPnPInvoke_AVTransport_Previous(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_Previous_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_Next_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void UPnPInvoke_AVTransport_Next(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_Next_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_Stop_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void UPnPInvoke_AVTransport_Stop(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_Stop_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_GetTransportSettings_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 2;
...
void UPnPInvoke_AVTransport_GetTransportSettings(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_GetTransportSettings_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_Seek_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void UPnPInvoke_AVTransport_Seek(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* Unit, char* Target)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_Seek_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_Pause_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void UPnPInvoke_AVTransport_Pause(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_Pause_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_GetPositionInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 8;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,unsigned int,char*,char*,char*,char*,char*,int,int))_InvokeData->CallbackPtr)(Service,UPnPGetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA);
			UPnPRelease(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void UPnPInvoke_AVTransport_GetPositionInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,unsigned int,char*,char*,char*,char*,char*,int,int), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_GetPositionInfo_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_GetTransportInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 3;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,char*,char*,char*))_InvokeData->CallbackPtr)(Service,UPnPGetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA,INVALID_DATA);
			UPnPRelease(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void UPnPInvoke_AVTransport_GetTransportInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*,char*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_GetTransportInfo_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_SetAVTransportURI_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void UPnPInvoke_AVTransport_SetAVTransportURI(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* CurrentURI, char* CurrentURIMetaData)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_SetAVTransportURI_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_GetDeviceCapabilities_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 3;
...
void UPnPInvoke_AVTransport_GetDeviceCapabilities(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,char*,char*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_GetDeviceCapabilities_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_SetPlayMode_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	if(done==0){return;}
...
void UPnPInvoke_AVTransport_SetPlayMode(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*), void* user, unsigned int InstanceID, char* NewPlayMode)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_SetPlayMode_Sink,service, invoke_data);	
	
	FREE(IP);
	FREE(Path);
}
void UPnPInvoke_AVTransport_GetMediaInfo_Sink(void *reader, struct packetheader *header, int IsInterrupt,char* buffer, int *p_BeginPointer, int EndPointer, int done, void* _service, void *state)
{
	struct UPnPService *Service = (struct UPnPService*)_service;
	struct InvokeStruct *_InvokeData = (struct InvokeStruct*)state;
	int ArgLeft = 9;
	...
	else
	{
		...
		{
			/* SOAP Fault */
			((void (*)(struct UPnPService*,int,void*,unsigned int,char*,char*,char*,char*,char*,char*,char*,char*))_InvokeData->CallbackPtr)(Service,UPnPGetErrorCode(buffer,EndPointer-(*p_BeginPointer)),_InvokeData->User,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA,INVALID_DATA);
			UPnPRelease(Service->Parent);
			FREE(_InvokeData);
			return;
		}
...
void UPnPInvoke_AVTransport_GetMediaInfo(struct UPnPService *service,void (*CallbackPtr)(struct UPnPService*,int,void*,unsigned int,char*,char*,char*,char*,char*,char*,char*,char*), void* user, unsigned int InstanceID)
{
	int headerLength;
	char *headerBuffer;
	char *SoapBodyTemplate;
	...
	invoke_data->CallbackPtr = CallbackPtr;
	invoke_data->User = user;
	ILibAddRequest_DirectEx(((struct UPnPCP*)service->Parent->CP)->HTTP, headerBuffer,headerLength,buffer,bufferLength,&addr, &UPnPInvoke_AVTransport_GetMediaInfo_Sink,service, invoke_data);	
