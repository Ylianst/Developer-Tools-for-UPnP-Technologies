...
struct ILibWebServer_Session
{
	...
	*/
	...
	char CertificateName[64]; // Used to store the CN field of the certificate
...
void * ILibWebServer_GetCPIdentity(ILibWebServer_ServerToken WebServerToken);
...
// vbl added Mesh specific code, used to store the NodeID in the web client
