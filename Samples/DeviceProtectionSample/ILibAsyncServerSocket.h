...
typedef void (*ILibAsyncServerSocket_OnConnect)(ILibAsyncServerSocket_ServerModule AsyncServerSocketModule, X509 * cert, STACK_OF(X509) *certChain, ILibAsyncServerSocket_ConnectionToken ConnectionToken, void **user);
#else
